...
seda_full <- full_join(county_poolsub, seda_cov, by="countyid")
...
kfr_coh_ela = lm(kfr_pooled_pooled_p25 ~ mn_grd_ela_ol + rswhtblk + rsecdnec, data = seda_oi)
kfr_coh_ela_1 = lm(kfr_pooled_pooled_p25 ~ mn_grd_ela_ol + rswhtblk + rsecdnec + sesavgall, data = seda_oi)
